# Fuzzing BiblePay Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing BiblePay Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/biblepay/biblepay/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/biblepay/biblepay/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/biblepay/biblepay/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/biblepay/biblepay/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the BiblePay Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BiblePay Core more robust.
...
with certain assembly code from BiblePay Core's code. See [developer notes on sanitizers](https://github.com/biblepay/biblepay/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing BiblePay Core using afl++

## Quickstart guide

To quickly get started fuzzing BiblePay Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing BiblePay Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing BiblePay Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the BiblePay Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as Biblepay
Core without having to write any custom fuzzing harness. The `biblepayd` server

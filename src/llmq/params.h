...
static constexpr std::array<LLMQParams, 14> available_llmqs = {
    ...
    /**
     * llmq_test (BiblePay Core 0.17) aka llmq_test_v17
     * This quorum is only used for testing
     *
     */
    LLMQParams{
    ...
    LLMQParams{
        ...
        .dkgInterval = 24 * 12, // one DKG every 24 hours
        .dkgPhaseBlocks = 4,
        .dkgMiningWindowStart = 20, // dkgPhaseBlocks * 5 = after finalization
        .dkgMiningWindowEnd = 28,   // give it a larger mining window to make sure it is mined

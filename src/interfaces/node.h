...
//! Interface for the src/evo part of a biblepay node (biblepayd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a biblepay node (biblepayd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a biblepay node (biblepayd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a biblepay node (biblepayd process).
...
//! Top-level interface for a biblepay node (biblepayd process).
class Node
{
public:
    virtual ~Node() {}

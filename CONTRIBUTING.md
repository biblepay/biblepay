...
First, in terms of structure, there is no particular concept of "BiblePay Core
...
Before you start contributing, familiarize yourself with the BiblePay Core build
system and tests. Refer to the documentation in the repository on how to build
BiblePay Core and how to run the unit and functional tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/biblepay/biblepay/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
Most communication about BiblePay Core development happens on Discord Server.
...
fork of BiblePay Core copies the merge. Instead, make any username mentions in a
...
Bitcoin Backports are an incredibly valuable part of BiblePay's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for BiblePay](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).

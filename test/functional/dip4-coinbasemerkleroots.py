...
class LLMQCoinbaseCommitmentsTest(BiblePayTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BiblePayTestFramework doesn't support this atm)

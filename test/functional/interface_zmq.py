...
from test_framework.messages import biblepayhash, hash256
...
def biblepayhash_reversed(byte_str):
    return biblepayhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], biblepayhash_reversed(block[:80]).hex())

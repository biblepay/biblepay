# Support for Output Descriptors in BiblePay Core

Since BiblePay Core v0.17, there is support for Output Descriptors. This is a
...
existing BiblePay Core wallets, a convenience function `combo` is
...
All RPCs in BiblePay Core will include the checksum in their output. Only

...
# Copyright (c) 2022-2024 The BiblePay Core developers
...
class AssetLocksTest(BiblepayTestFramework):
    def set_test_params(self):
        self.set_biblepay_test_params(5, 3, [["-whitelist=127.0.0.1", "-llmqtestinstantsenddip0024=llmq_test_instantsend"]] * 5, evo_count=3)

...
public:
    ...
    // BiblePay Specific WalletInitInterface InitPrivateSendSettings
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    if (mode == HMM_BITCOIN_QT)
        strUsage += HelpMessageOpt("-windowtitle=<name>", _("Sets a window title which is appended to \"BiblePay Core - \""));
...
bool AppInitMain()
{
    ...
    // Generate coins - RandomX - in the background

...
//
// OSX-specific way of handling biblepay: URIs
//
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("biblepay://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'biblepay://' is not a valid URI. Use 'biblepay:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // biblepay: URI
    {

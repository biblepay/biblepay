...
static const char* qt_argv = "biblepay-qt";
...
static void SetupUIArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-windowtitle=<name>", _("Sets a window title which is appended to \"BiblePay Core - \"").translated, ArgsManager::ALLOW_ANY, OptionsCategory::GUI);
}

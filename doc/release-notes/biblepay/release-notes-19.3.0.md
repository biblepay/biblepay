...
- `wipetxes`: New command for `biblepay-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/biblepay/biblepay/compare/v19.2.0...biblepay:v19.3.0).

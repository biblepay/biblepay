...
#define CLIENT_VERSION_SUFFIX "Hamans-Hanging-II"
...
#define ARCHIVE_GIT_DESCRIPTION "v20.1.0"
...
const std::string CLIENT_BUILD(BUILD_DESC CLIENT_SPACER CLIENT_VERSION_SUFFIX);

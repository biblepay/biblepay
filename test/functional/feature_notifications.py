...
# Copyright (c) 2023-2024 The BiblePay Core developers
...
class NotificationsTest(BiblepayTestFramework):
    def set_test_params(self):
        self.set_biblepay_test_params(6, 4, fast_dip3_enforcement=True)

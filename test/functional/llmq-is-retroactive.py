...
class LLMQ_IS_RetroactiveSigning(BiblePayTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_biblepay_test_params(6, 5, [["-whitelist=127.0.0.1"], [], [], [], ["-minrelaytxfee=0.001"], ["-minrelaytxfee=0.001"]], fast_dip3_enforcement=True)
        self.set_biblepay_llmq_test_params(5, 3)
        self.set_biblepay_dip8_activation(10)

...
"""Verify that starting biblepayd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start biblepayd with -h for help text")
        ...
        self.log.info("Start biblepayd with -version for version information")
        ...
        self.log.info("Start biblepaydd with -fakearg to make sure it does not start")

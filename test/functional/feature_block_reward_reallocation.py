#!/usr/bin/env python3
# Copyright (c) 2015-2020 The DÃSH Core Developers
...
class BlockRewardReallocationTest(BiblepayTestFramework):
    def set_test_params(self):
        self.set_biblepay_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_biblepay_dip8_activation(450)

...
TMPDIR_PREFIX = "biblepay_func_test_"
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def parse_args(self):
        ...
        parser.add_argument("--biblepayd-arg", dest="biblepayd_extra_args", default=[], action="append",
    ...
    def setup(self):
        ...
        fname_bitcoind = os.path.join(
            ...
            "src",
            "biblepayd" + config["environment"]["EXEEXT"],
        )
        fname_bitcoincli = os.path.join(
            config["environment"]["BUILDDIR"],
            "src",
            "biblepay-cli" + config["environment"]["EXEEXT"],
        )
    ...
    def setup_nodes(self):
        ...
        """If this method is updated - backport changes to  BiblepayTestFramework.setup_nodes"""
        extra_args = None
    ...
    def add_nodes(self, num_nodes: int, extra_args=None, *, rpchost=None, binary=None, binary_cli=None, versions=None):
        ...
        if binary is None:
            binary = [get_bin_from_version(v, 'biblepayd', self.options.bitcoind) for v in versions]
        if binary_cli is None:
            binary_cli = [get_bin_from_version(v, 'biblepay-cli', self.options.bitcoincli) for v in versions]
    ...
    def dynamically_initialize_datadir(self, node_p2p_port, node_rpc_port):
        ...
        with open(os.path.join(new_data_dir, "biblepay.conf"), 'w', encoding='utf8') as f:
    ...
    def _initialize_chain(self):
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain)  # Overwrite port/rpcport in biblepay.conf
    ...
    def skip_if_no_bitcoind_zmq(self):
        """Skip the running test if biblepayd has not been compiled with zmq support."""
        if not self.is_zmq_compiled():
            raise SkipTest("biblepayd has not been built with zmq enabled.")
    ...
    def skip_if_no_wallet_tool(self):
        """Skip the running test if biblepay-wallet has not been compiled."""
        if not self.is_wallet_tool_compiled():
            raise SkipTest("biblepay-wallet has not been compiled")

    def skip_if_no_cli(self):
        """Skip the running test if biblepay-cli has not been compiled."""
        if not self.is_cli_compiled():
            raise SkipTest("biblepay-cli has not been compiled.")
    ...
    def is_cli_compiled(self):
        """Checks whether biblepay-cli was compiled."""
    ...
    def is_wallet_tool_compiled(self):
        """Checks whether biblepay-wallet was compiled."""
...
class BiblepayTestFramework(BitcoinTestFramework):
    ...
    def set_biblepay_test_params(self, num_nodes, masterodes_count, extra_args=None, fast_dip3_enforcement=False, evo_count=0):
        ...
        self.set_biblepay_dip8_activation(200)
        ...
        # This is nRequestTimeout in biblepay-q-recovery thread

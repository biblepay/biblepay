...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "}\n"
            "\nResult (DEPRECATED. To see this result in v0.16 instead, please start biblepayd with -deprecatedrpc=addmultisigaddress).\n"
...
extern UniValue acceptgift(const JSONRPCRequest& request);
...
{ //  category              name                        actor (function)           argNames
	...
	{ "wallet",             "acceptgift",               &acceptgift,               {"privkey"} },

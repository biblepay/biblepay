#!/usr/bin/env python3
# Copyright (c) 2015-2023 The BiblePay Core developers
...
class LLMQ_IS_RetroactiveSigning(BiblepayTestFramework):
    def set_test_params(self):
        ...
        self.set_biblepay_test_params(5, 4, [["-whitelist=127.0.0.1"], [], [], [], ["-minrelaytxfee=0.001"]], fast_dip3_enforcement=True)
